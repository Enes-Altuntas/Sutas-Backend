...
def getAll(request, ume_db, app_db):
    try:
        badge = []
        msgParams = []
        ...
        if user_info[0]['user_type'] == 'SUP':
            ...
            if adet > 0:
                ...
                badgeBody['message'] = str(adet) + ' adet duyurunuz bulunmaktadır.'
    ...
    try:
        ...
        raise GenericException("Admin bilgileri çekilirken hata meydana geldi !", 408)
